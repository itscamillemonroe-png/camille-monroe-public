...
async function memberPage(){
  ...
  if(admin){banner.innerHTML='<strong>Owner controls active</strong><span>Creator Studio and member management are ready.</span>';banner.classList.add('activeAccess');}
