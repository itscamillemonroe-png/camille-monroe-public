...
async function init(){
  ...
  if(!profile.is_admin&&(profile.status!=='approved'||profile.verification_status!=='verified')){setMessageStatus('Approval and Didit verification are required for private messages.','error');$('#messageForm').hidden=true;return;}
